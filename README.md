...
Run the OllamaManager.exe file. You should see an icon in your system tray. Right-click on the icon to see the list of models you have added to the models.json file. If a model is currently loaded into VRAM, it will be indicated with a checkmark. You can click on a model to stop it from being loaded into VRAM.
